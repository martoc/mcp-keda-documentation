"""FastMCP server for KEDA documentation search and retrieval."""
...
DEFAULT_DB_PATH = Path(__file__).parent.parent.parent / "data" / "keda_docs.db"

# Initialise FastMCP server
mcp = FastMCP(name="keda-documentation")
...
def read_documentation(path: str) -> str:
    """Read the full content of a specific KEDA documentation page.

    Args:
        path: The relative path to the documentation file (e.g.,
              'docs/2.16/scalers/apache-kafka.md' or
              'data/faq.toml#what-is-keda'). This path
