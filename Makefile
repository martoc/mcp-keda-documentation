# Description: Makefile for Python MCP KEDA Documentation Server

PROJECT_NAME := mcp-keda-documentation
TARGET := ./target
...
index: ## Build the documentation index
	...
	$(PYTHON) -m mcp_keda_documentation.cli index

.PHONY: run
run: ## Run the MCP server
	@echo "==> Running MCP server..."
	$(PYTHON) -m mcp_keda_documentation.server

DOCKER_IMAGE := mcp-keda-documentation
